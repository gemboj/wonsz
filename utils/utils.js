...
WONSZ.utility = {  
    startGameLoop: function(gl, renderer, scene) {
        var lastTime = 0;
        var elapsed;
        var requestId;
    ...
    initShaders: function(gl, fShader, vShader, attribs, uniforms) {
        var fragmentShader = WONSZ.utility.getShader(gl, "shader-fs", fShader);
        var vertexShader = WONSZ.utility.getShader(gl, "shader-vs", vShader);
    ...
    getAULocations: function(gl, shaderProgram) {
    ...
    mouseClick: function(mycanvas, evt, scene, gl) {
